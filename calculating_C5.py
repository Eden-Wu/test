...
ur3_home_position = (math.radians(0),
                    math.radians(-90),
                    math.radians(0),
                    math.radians(-90),
                    math.radians(0),
...
robot.movej(q=ur3_home_position, a= ACCELERATION, v= VELOCITY )
